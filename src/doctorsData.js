...
export const doctors = [
  {
    ...
    shortBio: "As one of only 11 surgeons in the world accredited with a Fellowship from the International Society of Hair Restoration Surgery (ISHRS), Dr. Humayun is an internationally renowned Plastic, Cosmetic, and Hair Restoration Surgeon. He is widely recognized for his precision, innovation, and excellence in aesthetic medicine. With decades of experience, he has earned global trust for delivering refined, natural-looking results. His expertise in hairline design and advanced aesthetic procedures, combined with a patient-first philosophy, ensures personalized treatments in a safe and premium clinical environment.",
