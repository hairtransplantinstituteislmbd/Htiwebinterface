...
import React, { useEffect } from 'react';
import './AboutUs.css';
import htiServicesImg from '../Images/newformenu.webp'; 
  ...
  return (
    <div className="about-container">
      ...
      <div className="about-wrapper">
        ...
        {/* Expertise & Image Section (Side-by-Side Layout) */}
        <section className="about-card intro-section split-layout">
          ...
          <div className="image-content">
            <img 
              src={htiServicesImg} 
              alt="Dr. Humayun's Hair Transplant Institute Services" 
              className="side-img" 
            />
          </div>
