    ...
    <div className="about-institute-section">
      <div className="ai-container">
        ...
        <div className="ai-text-col">
          ...
          <p className="ai-desc">
            Dr. Humayon and the team at the Islamabad Hair Institute offer world-class treatment backed by over 30 years of expertise in the field of <Link to="/services" className="ai-link">hair restoration</Link>. Our doctors are nationally affiliated with professional associations including:
          </p>
