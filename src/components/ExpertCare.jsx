      ...
      <div className="expert-container">
        ...
        <div className="expert-left">
          ...
          <div className="testimonial-block">
            <p className="quote-text">
              “I give the highest marks possible to Dr. Humayun and his staff. The surgery I received was an FUT hair restoration... My experience at the  Hair Transplant Institute Clinic was A+++, and I would highly recommend this clinic to anyone. Thank you.”
            </p>
        ...
        <div className="expert-right">
          ...
          <p className="expert-desc">
            Dr. Humayun and Dr. Shahrukh provide advanced hair restoration care to patients from around the world. Their expertise includes <span className="green-text underline">Follicular Unit Transplantation (FUT)</span> And <span className="green-text underline">Follicular unit extraction (FUE)</span> , a precise technique that transplants small groups of follicles.
          </p>

          <p className="expert-desc">
            At the  Hair Transplant Institute Islamabad, we want our services to be accessible and affordable, which is why we make paying for treatment easy. We accept all major credit cards including Visa, Mastercard, Discover, and American Express.
          </p>
