...
const ContactForm = () => {
  ...
  const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzvmR0kGHaBcdV9FnXu_SMn0WT9OY3RGPIGd4va4zJE6J2tdQ6rCh8dzYlluPWvA6GN/exec"; 
 ...
 <div className="info-row">
              ...
              <span>Phone No: 051-8441444</span>
            </div>


             <div className="info-row">
            
              <span>Cell No: 0321-5000242</span>
            </div>
             <div className="info-row">
            
              <span>WhatsApp: 0321-5000242</span>
            </div>

             <div className="info-row">
            
              <span>WhatsApp: +92-300-9558737</span>
            </div>
          

             <div className="info-row">
            
              <span>  Email Address: info@hti.com.pk</span>
            </div>
            <div className="info-row">
